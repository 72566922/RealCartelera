CREATE DATABASE  IF NOT EXISTS `realcartelera` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `realcartelera`;
...
INSERT INTO `bebida` VALUES (1,1.5,7.5,85,2),(2,0.5,3.5,191,1),(3,1,3.3,70,3);
...
INSERT INTO `boleto` VALUES (1,4,1,2),(2,6,4,1),(3,270,8,2),(4,271,9,1),(5,6,1,1),(7,8,4,1),(8,9,1,15);
...
INSERT INTO `comida` VALUES (1,500,24.5,31,4),(2,330,12.2,148,5);
...
-- Dump completed on 2024-10-26 11:36:15
